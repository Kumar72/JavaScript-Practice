...
/************************* Your Solution *************************/
	...
	for (var state in states) {
		if (Math.sqrt(Math.pow(states[state].lat - lat,2) +
		 Math.pow(states[state].long - long,2))<= distance) {
...
/************************* Your Solution *************************/
	var github = {};
	github.committer = commit.committer.name;
	github.timestamp = commit.committer.date;
	github.msg = commit.message;
	github.sha = commit.tree.sha;
